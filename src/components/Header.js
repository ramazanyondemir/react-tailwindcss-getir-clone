...
export default function Header() {
  return (
    <div className="h-16 md:h-auto bg-primary-brand-color md:bg-brand-color flex items-center justify-center px-[6px] lg:sticky lg:inset-0 lg:z-30">
      <nav className="container h-[45px] flex justify-center md:justify-between sticky">
        {/* NAV SOL  */}
        <div className="h-full flex">
          <a
            href="#"
            className="bg-primary-brand-color inline-flex  md:h-10 py-[10px] px-2 align-center md:mt-[5px] rounded-t-md md:py-3 md:px-5"
          >
        ...
        {/* NAV SAĞ */}
        <nav className="hidden md:flex gap-x-1 text-sm font-bold text-gray-200 leading-[19px]">
